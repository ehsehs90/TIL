...
​	-  일부 프레임워크를 제외하고는 대부분 위의 두가지로 수행해야 한다.
...
app_name='articles'
urlpatterns = [
    path('<int:article_pk>/update/', views.update, name='update'), # UPDATE Logic - 폼 전달
...
- 통일을 위해 new.html을 create.html로 Rename 한다
...
- 통일을 위해 edit.html 을 update.html 로 Rename 한다
